...
export interface AppContextType {
  ...
  // Kinematic Controls (CV)
  isKinematicEnabled: boolean;
  setIsKinematicEnabled: (enabled: boolean) => void;
  kinematicLeftStickRef: MutableRefObject<[number, number]>; // [x, y] -1 to 1
  kinematicRightStickRef: MutableRefObject<[number, number]>; // [x, y] -1 to 1
