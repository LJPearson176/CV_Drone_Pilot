...
const ControlsConfigPanel: React.FC = () => {
    const { controlConfig, handleControlConfigChange, isKinematicEnabled, setIsKinematicEnabled } = useAppContext();
    ...
    return (
        <div className="space-y-4">
            <div>
                 <h3 className="text-sm font-semibold text-gray-400 px-1 mb-2">Input Method</h3>
                 <div className="space-y-2">
                     <ToggleSwitch
                         label="Kinematic Controls (Beta)"
                         description="Use your webcam to control the ship with virtual hand joysticks."
                         checked={isKinematicEnabled}
                         onChange={setIsKinematicEnabled}
                     />
                 </div>
            </div>
            <div>
